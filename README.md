...
For continued practice with Backbone models and collections I created a Like button that updates when clicked.  
...
which is located [HERE]
   ...
   [HERE]: <https://frazierr2.github.io/6.1-like-button/>
